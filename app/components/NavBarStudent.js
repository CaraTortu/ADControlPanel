    ...
    return (
        <nav className='bg-gray-700 fixed top-0 shadow-lg duration-300 h-full w-20 left-0'>
            ...
            <div className="w-full h-full flex flex-col items-center justify-center text-white gap-4">
                <a href="/dashboard/student" id="home" className="p-3 flex justify-center rounded-lg items-center hover:bg-gray-800 duration-300">
                ...
                <a href="/dashboard/student/user" id="items" className="p-3 flex justify-center rounded-lg items-center  hover:bg-gray-800 duration-300">
                ...
                <a href="/dashboard/student/drive" id="rent" className="p-3 flex justify-center rounded-lg items-center  hover:bg-gray-800 duration-300">
